...
custom_imports = dict(imports=['projects.openlanev2.baseline', 'projects.toponet_openlanev2.toponet'])
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
         init_kwargs={'project': 'neural-map-learning', 'name': 'openlane-toponet-graph-transf-norm'},)
    ])

checkpoint_config = dict(interval=1, max_keep_ckpts=1)

dist_params = dict(backend='nccl')
# dist_params = dict(backend='nccl', timeout=timedelta(seconds=18000))
log_level = 'INFO'
work_dir = None
load_from = None
resume_from = None
